  ...
  <div class="min-h-screen flex">
    ...
    <div class="w-full md:w-1/2 flex items-center justify-center bg-white min-h-screen">
      <div class="w-full max-w-sm p-6">
        ...
        <h2 class="text-xl font-semibold text-blue-700 mt-8 mb-6 text-center">Cadastro</h2>
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <button
            type="submit"
            class="w-full bg-gradient-to-br from-purple-500 to-indigo-600 text-white py-2 rounded hover:bg-blue-800 transition"
          >
            Cadastrar
          </button>
        </form>
