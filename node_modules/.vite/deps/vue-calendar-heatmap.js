...
// node_modules/vue-calendar-heatmap/dist/vue-calendar-heatmap.common.js
var require_vue_calendar_heatmap_common = __commonJS({
  "node_modules/vue-calendar-heatmap/dist/vue-calendar-heatmap.common.js"(exports, module) {
    module.exports = function(modules) {
      ...
      var DEFAULT_RANGE_COLOR = ["#ebedf0", "#c0ddf9", "#73b3f3", "#3886e1", "#17459e"], DEFAULT_LOCALE = { months: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], days: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], on: "on", less: "Less", more: "More" }, DEFAULT_TOOLTIP_UNIT = "contributions", DAYS_IN_ONE_YEAR = 365, DAYS_IN_WEEK = 7, SQUARE_SIZE = 10;
      ...
      var __WEBPACK_IMPORTED_MODULE_0__consts__ = __webpack_require__(0), _createClass = /* @__PURE__ */ function() {
        ...
        function CalendarHeatmap2(endDate, values, max) {
          _classCallCheck(this, CalendarHeatmap2), this.endDate = this._parseDate(endDate), this.max = max || Math.ceil(Math.max.apply(Math, _toConsumableArray(values.map(function(day) {
            return day.count;
          }))) / 5 * 4), this.startDate = this._shiftDate(endDate, -__WEBPACK_IMPORTED_MODULE_0__consts__.f), this.values = values;
        }
        return _createClass(CalendarHeatmap2, [{ key: "getColorIndex", value: function(value) {
          return value <= 0 ? 0 : value >= this.max ? 4 : Math.ceil(100 * value / this.max * 0.03);
        } }, { key: "getCountEmptyDaysAtStart", value: function() {
          return this.startDate.getDay();
        } }, { key: "getCountEmptyDaysAtEnd", value: function() {
          return __WEBPACK_IMPORTED_MODULE_0__consts__.c - 1 - this.endDate.getDay();
        } }, { key: "getDaysCount", value: function() {
          return __WEBPACK_IMPORTED_MODULE_0__consts__.f + 1 + this.getCountEmptyDaysAtStart() + this.getCountEmptyDaysAtEnd();
        } }, { key: "_shiftDate", value: function(date, numDays) {
          var newDate = new Date(date);
          return newDate.setDate(newDate.getDate() + numDays), newDate;
        } }, { key: "_parseDate", value: function(entry) {
          return entry instanceof Date ? entry : new Date(entry);
        } }, { key: "_keyDayParser", value: function(date) {
          var day = this._parseDate(date);
          return day.getFullYear() + "-" + day.getMonth() + "-" + day.getDate();
        } }, { key: "activities", get: function() {
          var _this = this;
          return this.values.reduce(function(newValues, day) {
            return newValues[_this._keyDayParser(day.date)] = { count: day.count, colorIndex: _this.getColorIndex(day.count) }, newValues;
          }, {});
        } }, { key: "weekCount", get: function() {
          return this.getDaysCount() / __WEBPACK_IMPORTED_MODULE_0__consts__.c;
        } }, { key: "calendar", get: function() {
          var _this2 = this, date = this._shiftDate(this.startDate, -this.getCountEmptyDaysAtStart());
          return Array.from({ length: this.weekCount }, function() {
            return Array.from({ length: __WEBPACK_IMPORTED_MODULE_0__consts__.c }, function() {
              var dDate = new Date(date.getFullYear(), date.getMonth(), date.getDate()), dayValues = _this2.activities[_this2._keyDayParser(dDate)];
              return date.setDate(date.getDate() + 1), { date: dDate, count: dayValues ? dayValues.count : 0, colorIndex: dayValues ? dayValues.colorIndex : 0 };
            });
          });
        } }, { key: "firstFullWeekOfMonths", get: function() {
          return this.calendar.reduce(function(months, week, index, weeks) {
            if (index > 0) {
              var lastWeek = weeks[index - 1][0].date, currentWeek = week[0].date;
              (lastWeek.getFullYear() < currentWeek.getFullYear() || lastWeek.getMonth() < currentWeek.getMonth()) && months.push({ value: currentWeek.getMonth(), index });
            }
            return months;
          }, []);
        } }]), CalendarHeatmap2;
      ...
      var __WEBPACK_IMPORTED_MODULE_0__components_CalendarHeatmap_vue__ = __webpack_require__(1), __WEBPACK_IMPORTED_MODULE_0__components_CalendarHeatmap_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_CalendarHeatmap_vue__);
      ...
      var plugin = { version: "0.8.4", install };
      ...
      function microtaskDebounce(fn) {
        var called = false;
        return function() {
          called || (called = true, window.Promise.resolve().then(function() {
            called = false, fn();
          }));
        };
      }
      function taskDebounce(fn) {
        var scheduled = false;
        return function() {
          scheduled || (scheduled = true, setTimeout(function() {
            scheduled = false, fn();
          }, timeoutDuration));
        };
      }
      ...
      function getScrollParent(element) {
        ...
        var _getStyleComputedProp = getStyleComputedProperty(element), overflow = _getStyleComputedProp.overflow, overflowX = _getStyleComputedProp.overflowX;
      ...
      function getScroll(element) {
        var side = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "top", upperSide = "top" === side ? "scrollTop" : "scrollLeft", nodeName = element.nodeName;
      ...
      function getBoundingClientRect(element) {
        ...
        var result = { left: rect.left, top: rect.top, width: rect.right - rect.left, height: rect.bottom - rect.top }, sizes = "HTML" === element.nodeName ? getWindowSizes() : {}, width = sizes.width || element.clientWidth || result.right - result.left, height = sizes.height || element.clientHeight || result.bottom - result.top, horizScrollbar = element.offsetWidth - width, vertScrollbar = element.offsetHeight - height;
      ...
      function getOffsetRectRelativeToArbitraryNode(children, parent) {
        var fixedPosition = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], isIE102 = isIE(10), isHTML = "HTML" === parent.nodeName, childrenRect = getBoundingClientRect(children), parentRect = getBoundingClientRect(parent), scrollParent = getScrollParent(children), styles = getStyleComputedProperty(parent), borderTopWidth = parseFloat(styles.borderTopWidth, 10), borderLeftWidth = parseFloat(styles.borderLeftWidth, 10);
        ...
        if (offsets.marginTop = 0, offsets.marginLeft = 0, !isIE102 && isHTML) {
          var marginTop = parseFloat(styles.marginTop, 10), marginLeft = parseFloat(styles.marginLeft, 10);
        ...
        return (isIE102 && !fixedPosition ? parent.contains(scrollParent) : parent === scrollParent && "BODY" !== scrollParent.nodeName) && (offsets = includeScroll(offsets, parent)), offsets;
      }
      function getViewportOffsetRectRelativeToArtbitraryNode(element) {
        ...
        return getClientRect({ top: scrollTop - relativeOffset.top + relativeOffset.marginTop, left: scrollLeft - relativeOffset.left + relativeOffset.marginLeft, width, height });
      }
      ...
      function getBoundaries(popper, reference, padding, boundariesElement) {
        var fixedPosition = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], boundaries = { top: 0, left: 0 }, offsetParent = fixedPosition ? getFixedPositionOffsetParent(popper) : findCommonOffsetParent(popper, reference);
      ...
      function getOuterSizes(element) {
        var styles = getComputedStyle(element), x = parseFloat(styles.marginTop) + parseFloat(styles.marginBottom), y = parseFloat(styles.marginLeft) + parseFloat(styles.marginRight);
      ...
      function runModifiers(modifiers2, data, ends) {
        return (void 0 === ends ? modifiers2 : modifiers2.slice(0, findIndex(modifiers2, "name", ends))).forEach(function(modifier) {
      ...
      function update() {
        if (!this.state.isDestroyed) {
          ...
          data.offsets.reference = getReferenceOffsets(this.state, this.popper, this.reference, this.options.positionFixed), data.placement = computeAutoPlacement(this.options.placement, data.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), data.originalPlacement = data.placement, data.positionFixed = this.options.positionFixed, data.offsets.popper = getPopperOffsets(this.popper, data.offsets.reference, data.placement), data.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", data = runModifiers(this.modifiers, data), this.state.isCreated ? this.options.onUpdate(data) : (this.state.isCreated = true, this.options.onCreate(data));
        }
      }
      ...
      function getSupportedPropertyName(property) {
        for (var prefixes = [false, "ms", "Webkit", "Moz", "O"], upperProp = property.charAt(0).toUpperCase() + property.slice(1), i2 = 0; i2 < prefixes.length; i2++) {
      ...
      function attachToScrollParents(scrollParent, event, callback, scrollParents) {
        ...
        target.addEventListener(event, callback, { passive: true }), isBody || attachToScrollParents(getScrollParent(target.parentNode), event, callback, scrollParents), scrollParents.push(target);
      }
      function setupEventListeners(reference, options, state2, updateBound) {
        state2.updateBound = updateBound, getWindow(reference).addEventListener("resize", state2.updateBound, { passive: true });
        var scrollElement = getScrollParent(reference);
        return attachToScrollParents(scrollElement, "scroll", state2.updateBound, state2.scrollParents), state2.scrollElement = scrollElement, state2.eventsEnabled = true, state2;
      }
      ...
      function removeEventListeners(reference, state2) {
        return getWindow(reference).removeEventListener("resize", state2.updateBound), state2.scrollParents.forEach(function(target) {
          target.removeEventListener("scroll", state2.updateBound);
        }), state2.updateBound = null, state2.scrollParents = [], state2.scrollElement = null, state2.eventsEnabled = false, state2;
      }
      ...
      function setAttributes(element, attributes) {
        Object.keys(attributes).forEach(function(prop) {
          false !== attributes[prop] ? element.setAttribute(prop, attributes[prop]) : element.removeAttribute(prop);
        });
      }
      ...
      function applyStyleOnLoad(reference, popper, options, modifierOptions, state2) {
        var referenceOffsets = getReferenceOffsets(state2, popper, reference, options.positionFixed), placement = computeAutoPlacement(options.placement, referenceOffsets, popper, reference, options.modifiers.flip.boundariesElement, options.modifiers.flip.padding);
      ...
      function computeStyle(data, options) {
        ...
        var gpuAcceleration = void 0 !== legacyGpuAccelerationOption ? legacyGpuAccelerationOption : options.gpuAcceleration, offsetParent = getOffsetParent(data.instance.popper), offsetParentRect = getBoundingClientRect(offsetParent), styles = { position: popper.position }, offsets = { left: Math.floor(popper.left), top: Math.round(popper.top), bottom: Math.round(popper.bottom), right: Math.floor(popper.right) }, sideA = "bottom" === x ? "top" : "bottom", sideB = "right" === y ? "left" : "right", prefixedProperty = getSupportedPropertyName("transform"), left = void 0, top = void 0;
      ...
      function parseOffset(offset2, popperOffsets, referenceOffsets, basePlacement) {
        var offsets = [0, 0], useHeight = -1 !== ["right", "left"].indexOf(basePlacement), fragments = offset2.split(/(\+|\-)/).map(function(frag) {
          return frag.trim();
        ...
        return ops = ops.map(function(op, index) {
          var measurement = (1 === index ? !useHeight : useHeight) ? "height" : "width", mergeWithPrevious = false;
          return op.reduce(function(a, b) {
            return "" === a[a.length - 1] && -1 !== ["+", "-"].indexOf(b) ? (a[a.length - 1] = b, mergeWithPrevious = true, a) : mergeWithPrevious ? (a[a.length - 1] += b, mergeWithPrevious = false, a) : a.concat(b);
          }, []).map(function(str) {
      ...
      function hide(data) {
        ...
        if (refRect.bottom < bound.top || refRect.left > bound.right || refRect.top > bound.bottom || refRect.right < bound.left) {
          if (true === data.hide) return data;
          data.hide = true, data.attributes["x-out-of-boundaries"] = "";
        } else {
          if (false === data.hide) return data;
      ...
      function addClasses(el, classes) {
        var newClasses = convertToArray(classes), classList = void 0;
      ...
      function createTooltip(el, value) {
        var modifiers2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, content = getContent(value), classes = void 0 !== value.classes ? value.classes : directive.options.defaultClass, opts2 = _extends$1({ title: content }, getOptions(_extends$1({}, value, { placement: getPlacement(value, modifiers2) }))), tooltip = el._tooltip = new Tooltip(el, opts2);
      ...
      function bind(el, _ref) {
        var value = _ref.value, modifiers2 = (_ref.oldValue, _ref.modifiers), content = getContent(value);
        if (content && state.enabled) {
          var tooltip = void 0;
          el._tooltip ? (tooltip = el._tooltip, tooltip.setContent(content), tooltip.setOptions(_extends$1({}, value, { placement: getPlacement(value, modifiers2) }))) : tooltip = createTooltip(el, value, modifiers2), void 0 !== value.show && value.show !== el._tooltipOldShow && (el._tooltipOldShow = value.show, value.show ? tooltip.show() : tooltip.hide());
        } else destroyTooltip(el);
      }
      function addListeners(el) {
        el.addEventListener("click", onClick), el.addEventListener("touchstart", onTouchStart, !!supportsPassive && { passive: true });
      }
      ...
      function onTouchEnd(event) {
        var el = event.currentTarget;
        if (el.$_vclosepopover_touch = false, 1 === event.changedTouches.length) {
          var touch = event.changedTouches[0], firstTouch = el.$_vclosepopover_touchPoint;
      ...
      function onTouchCancel(event) {
        event.currentTarget.$_vclosepopover_touch = false;
      }
      ...
      function initCompat() {
        initCompat.init || (initCompat.init = true, isIE$1 = -1 !== getInternetExplorerVersion());
      }
      ...
      function handleGlobalClose(event) {
        ...
        requestAnimationFrame(function() {
          for (var popover = void 0, i2 = 0; i2 < openPopovers.length; i2++) if (popover = openPopovers[i2], popover.$refs.popover) {
      ...
      var supportsMicroTasks = isBrowser && window.Promise, debounce = supportsMicroTasks ? microtaskDebounce : taskDebounce, isIE11 = isBrowser && !(!window.MSInputMethodContext || !document.documentMode), isIE10 = isBrowser && /MSIE 10/.test(navigator.userAgent), classCallCheck = function(instance, Constructor) {
        if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        ...
        return target;
      }, placements = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"], validPlacements = placements.slice(3), BEHAVIORS = { FLIP: "flip", CLOCKWISE: "clockwise", COUNTERCLOCKWISE: "counterclockwise" }, modifiers = { shift: { order: 100, enabled: true, fn: shift }, offset: { order: 200, enabled: true, fn: offset, offset: 0 }, preventOverflow: { order: 300, enabled: true, fn: preventOverflow, priority: ["left", "right", "top", "bottom"], padding: 5, boundariesElement: "scrollParent" }, keepTogether: { order: 400, enabled: true, fn: keepTogether }, arrow: { order: 500, enabled: true, fn: arrow, element: "[x-arrow]" }, flip: { order: 600, enabled: true, fn: flip, behavior: "flip", padding: 5, boundariesElement: "viewport" }, inner: { order: 700, enabled: false, fn: inner }, hide: { order: 800, enabled: true, fn: hide }, computeStyle: { order: 850, enabled: true, fn: computeStyle, gpuAcceleration: true, x: "bottom", y: "right" }, applyStyle: { order: 900, enabled: true, fn: applyStyle, onLoad: applyStyleOnLoad, gpuAcceleration: void 0 } }, Defaults = { placement: "bottom", positionFixed: false, eventsEnabled: true, removeOnDestroy: false, onCreate: function() {
      }, onUpdate: function() {
      ...
      var _typeof = "function" == typeof Symbol && "symbol" === _typeof2(Symbol.iterator) ? function(obj) {
        ...
        if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
      }, createClass$1 = /* @__PURE__ */ function() {
        function defineProperties(target, props) {
          for (var i2 = 0; i2 < props.length; i2++) {
            var descriptor = props[i2];
            descriptor.enumerable = descriptor.enumerable || false, descriptor.configurable = true, "value" in descriptor && (descriptor.writable = true), Object.defineProperty(target, descriptor.key, descriptor);
        ...
        return target;
      }, DEFAULT_OPTIONS = { container: false, delay: 0, html: false, placement: "top", title: "", template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", offset: 0 }, openTooltips = [], Tooltip = function() {
        function Tooltip2(reference, options) {
          classCallCheck$1(this, Tooltip2), _initialiseProps.call(this), options = _extends$1({}, DEFAULT_OPTIONS, options), reference.jquery && (reference = reference[0]), this.reference = reference, this.options = options, this._isOpen = false, this._init();
        }
        return createClass$1(Tooltip2, [{ key: "setClasses", value: function(classes) {
        ...
        } }, { key: "setOptions", value: function(options) {
          var classesUpdated = false, classes = options && options.classes || directive.options.defaultClass;
          this._classes !== classes && (this.setClasses(classes), classesUpdated = true), options = getOptions(options);
          var needPopperUpdate = false, needRestart = false;
          this.options.offset === options.offset && this.options.placement === options.placement || (needPopperUpdate = true), (this.options.template !== options.template || this.options.trigger !== options.trigger || this.options.container !== options.container || classesUpdated) && (needRestart = true);
          ...
          this._isDisposed = false, this._enableDocumentTouch = -1 === events.indexOf("manual"), this._setEventListeners(this.reference, events, this.options);
        } }, { key: "_create", value: function(reference, template) {
        ...
        } }, { key: "_setContent", value: function(content, options) {
          var _this = this;
          this.asyncContent = false, this._applyContent(content, options).then(function() {
            _this.popperInstance.update();
          });
        } }, { key: "_applyContent", value: function(title, options) {
          var _this2 = this;
          return new Promise(function(resolve, reject) {
            var allowHtml = options.html, rootNode = _this2._tooltipNode, titleNode = rootNode.querySelector(_this2.options.innerSelector);
            if (1 === title.nodeType) {
              if (allowHtml) {
              ...
              if ("function" == typeof title) {
                var result = title();
                return void (result && "function" == typeof result.then ? (_this2.asyncContent = true, options.loadingClass && addClasses(rootNode, options.loadingClass), options.loadingContent && _this2._applyContent(options.loadingContent, options), result.then(function(asyncResult) {
        ...
        } }, { key: "_show", value: function(reference, options) {
          ...
          this._tooltipNode && (addClasses(this._tooltipNode, this._classes), updateClasses = false);
        ...
        } }, { key: "_ensureShown", value: function(reference, options) {
          var _this3 = this;
          if (this._isOpen) return this;
          if (this._isOpen = true, openTooltips.push(this), this._tooltipNode) return this._tooltipNode.style.display = "", this._tooltipNode.setAttribute("aria-hidden", "false"), this.popperInstance.enableEventListeners(), this.popperInstance.update(), this.asyncContent && this._setContent(options.title, options), this;
          ...
          var popperOptions = _extends$1({}, options.popperOptions, { placement: options.placement });
          return popperOptions.modifiers = _extends$1({}, popperOptions.modifiers, { arrow: { element: this.options.arrowSelector } }), options.boundariesElement && (popperOptions.modifiers.preventOverflow = { boundariesElement: options.boundariesElement }), this.popperInstance = new Popper(reference, tooltipNode, popperOptions), requestAnimationFrame(function() {
          ...
          var _this4 = this;
          if (!this._isOpen) return this;
          this._isOpen = false, this._noLongerOpen(), this._tooltipNode.style.display = "none", this._tooltipNode.setAttribute("aria-hidden", "true"), this.popperInstance.disableEventListeners(), clearTimeout(this._disposeTimer);
          ...
          var _this5 = this;
          return this._isDisposed = true, this._events.forEach(function(_ref) {
        ...
        } }, { key: "_findContainer", value: function(container, reference) {
          return "string" == typeof container ? container = window.document.querySelector(container) : false === container && (container = reference.parentNode), container;
        } }, { key: "_append", value: function(tooltipNode, container) {
          container.appendChild(tooltipNode);
        } }, { key: "_setEventListeners", value: function(reference, events, options) {
          var _this6 = this, directEvents = [], oppositeEvents = [];
          events.forEach(function(event) {
            ...
            var func = function(evt) {
              true !== _this6._isOpen && (evt.usedByTooltip = true, _this6._scheduleShow(reference, options.delay, options, evt));
            };
            _this6._events.push({ event, func }), reference.addEventListener(event, func);
          }), oppositeEvents.forEach(function(event) {
            var func = function(evt) {
              true !== evt.usedByTooltip && _this6._scheduleHide(reference, options.delay, options, evt);
            };
            _this6._events.push({ event, func }), reference.addEventListener(event, func);
          });
        } }, { key: "_onDocumentTouch", value: function(event) {
          this._enableDocumentTouch && this._scheduleHide(this.reference, this.options.delay, this.options, event);
        } }, { key: "_scheduleShow", value: function(reference, delay, options) {
          var _this7 = this, computedDelay = delay && delay.show || delay || 0;
          clearTimeout(this._scheduleTimer), this._scheduleTimer = window.setTimeout(function() {
            return _this7._show(reference, options);
          }, computedDelay);
        } }, { key: "_scheduleHide", value: function(reference, delay, options, evt) {
          var _this8 = this, computedDelay = delay && delay.hide || delay || 0;
          clearTimeout(this._scheduleTimer), this._scheduleTimer = window.setTimeout(function() {
            if (false !== _this8._isOpen && document.body.contains(_this8._tooltipNode)) {
        ...
        this.show = function() {
          ...
          var relatedreference = evt.relatedreference || evt.toElement || evt.relatedTarget, callback = function callback2(evt2) {
            var relatedreference2 = evt2.relatedreference || evt2.toElement || evt2.relatedTarget;
            _this9._tooltipNode.removeEventListener(evt.type, callback2), reference.contains(relatedreference2) || _this9._scheduleHide(reference, options.delay, options, evt2);
          };
          return !!_this9._tooltipNode.contains(relatedreference) && (_this9._tooltipNode.addEventListener(evt.type, callback), true);
        };
      };
      "undefined" != typeof document && document.addEventListener("touchstart", function(event) {
        for (var i2 = 0; i2 < openTooltips.length; i2++) openTooltips[i2]._onDocumentTouch(event);
      }, !supportsPassive || { passive: true, capture: true });
      var state = { enabled: true }, positions = ["top", "top-start", "top-end", "right", "right-start", "right-end", "bottom", "bottom-start", "bottom-end", "left", "left-start", "left-end"], defaultOptions = { defaultPlacement: "top", defaultClass: "vue-tooltip-theme", defaultTargetClass: "has-tooltip", defaultHtml: true, defaultTemplate: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', defaultArrowSelector: ".tooltip-arrow, .tooltip__arrow", defaultInnerSelector: ".tooltip-inner, .tooltip__inner", defaultDelay: 0, defaultTrigger: "hover focus", defaultOffset: 0, defaultContainer: "body", defaultBoundariesElement: void 0, defaultPopperOptions: {}, defaultLoadingClass: "tooltip-loading", defaultLoadingContent: "...", autoHide: true, defaultHideOnTargetClick: true, disposeTimeout: 5e3, popover: { defaultPlacement: "bottom", defaultClass: "vue-popover-theme", defaultBaseClass: "tooltip popover", defaultWrapperClass: "wrapper", defaultInnerClass: "tooltip-inner popover-inner", defaultArrowClass: "tooltip-arrow popover-arrow", defaultDelay: 0, defaultTrigger: "click", defaultOffset: 0, defaultContainer: "body", defaultBoundariesElement: void 0, defaultPopperOptions: {}, defaultAutoHide: true, defaultHandleResize: true } }, directive = { options: defaultOptions, bind, update: bind, unbind: function(el) {
        destroyTooltip(el);
      } }, vclosepopover = { bind: function(el, _ref) {
        var value = _ref.value, modifiers2 = _ref.modifiers;
        el.$_closePopoverModifiers = modifiers2, (void 0 === value || value) && addListeners(el);
      }, update: function(el, _ref2) {
        var value = _ref2.value, oldValue = _ref2.oldValue, modifiers2 = _ref2.modifiers;
        el.$_closePopoverModifiers = modifiers2, value !== oldValue && (void 0 === value || value ? addListeners(el) : removeListeners(el));
      }, unbind: function(el) {
        removeListeners(el);
      } }, isIE$1 = void 0, ResizeObserver = { render: function() {
        var _vm = this, _h = _vm.$createElement;
        return (_vm._self._c || _h)("div", { staticClass: "resize-observer", attrs: { tabindex: "-1" } });
      }, staticRenderFns: [], _scopeId: "data-v-b329ee4c", name: "resize-observer", methods: { notify: function() {
        this.$emit("notify");
      ...
      } }, plugin$2 = { version: "0.4.4", install: install$1 }, GlobalVue$1 = null;
      ...
      var openPopovers = [], Element = function() {
      };
      "undefined" != typeof window && (Element = window.Element);
      var Popover = { render: function() {
      ...
      }, staticRenderFns: [], name: "VPopover", components: { ResizeObserver }, props: { open: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, placement: { type: String, default: function() {
        return getDefault("defaultPlacement");
      } }, delay: { type: [String, Number, Object], default: function() {
        return getDefault("defaultDelay");
      } }, offset: { type: [String, Number], default: function() {
        return getDefault("defaultOffset");
      } }, trigger: { type: String, default: function() {
        return getDefault("defaultTrigger");
      } }, container: { type: [String, Object, Element], default: function() {
        return getDefault("defaultContainer");
      } }, boundariesElement: { type: Element, default: function() {
        return getDefault("defaultBoundariesElement");
      } }, popperOptions: { type: Object, default: function() {
        return getDefault("defaultPopperOptions");
      } }, popoverClass: { type: [String, Array], default: function() {
        return getDefault("defaultClass");
      } }, popoverBaseClass: { type: [String, Array], default: function() {
        return directive.options.popover.defaultBaseClass;
      } }, popoverInnerClass: { type: [String, Array], default: function() {
        return directive.options.popover.defaultInnerClass;
      } }, popoverWrapperClass: { type: [String, Array], default: function() {
        return directive.options.popover.defaultWrapperClass;
      } }, popoverArrowClass: { type: [String, Array], default: function() {
        return directive.options.popover.defaultArrowClass;
      } }, autoHide: { type: Boolean, default: function() {
        return directive.options.popover.defaultAutoHide;
      } }, handleResize: { type: Boolean, default: function() {
        return directive.options.popover.defaultHandleResize;
      } }, openGroup: { type: String, default: null } }, data: function() {
        return { isOpen: false, id: Math.random().toString(36).substr(2, 10) };
        ...
        if (this.isOpen && this.popperInstance) {
          var popoverNode = this.$refs.popover, reference = this.$refs.trigger, container = this.$_findContainer(this.container, reference);
      ...
      }, offset: "$_restartPopper", boundariesElement: "$_restartPopper", popperOptions: { handler: "$_restartPopper", deep: true } }, created: function() {
        this.$_isDisposed = false, this.$_mounted = false, this.$_events = [], this.$_preventOpen = false;
      }, mounted: function() {
        ...
        var _this2 = this, _ref = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, event = _ref.event, _ref$force = (_ref.skipDelay, _ref.force);
        !(void 0 !== _ref$force && _ref$force) && this.disabled || (this.$_scheduleShow(event), this.$emit("show")), this.$emit("update:open", true), this.$_beingShowed = true, requestAnimationFrame(function() {
          _this2.$_beingShowed = false;
        });
      }, hide: function() {
        var _ref2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, event = _ref2.event;
        _ref2.skipDelay;
        this.$_scheduleHide(event), this.$emit("hide"), this.$emit("update:open", false);
      }, dispose: function() {
        if (this.$_isDisposed = true, this.$_removeEventListeners(), this.hide({ skipDelay: true }), this.popperInstance && (this.popperInstance.destroy(), !this.popperInstance.options.removeOnDestroy)) {
          var popoverNode = this.$refs.popover;
          popoverNode.parentNode && popoverNode.parentNode.removeChild(popoverNode);
        }
        this.$_mounted = false, this.popperInstance = null, this.isOpen = false, this.$emit("dispose");
      }, $_init: function() {
        -1 === this.trigger.indexOf("manual") && this.$_addEventListeners();
      }, $_show: function() {
        var _this3 = this, reference = this.$refs.trigger, popoverNode = this.$refs.popover;
        if (clearTimeout(this.$_disposeTimer), !this.isOpen) {
          if (this.popperInstance && (this.isOpen = true, this.popperInstance.enableEventListeners(), this.popperInstance.scheduleUpdate()), !this.$_mounted) {
            var container = this.$_findContainer(this.container, reference);
            if (!container) return void console.warn("No container for popover", this);
            container.appendChild(popoverNode), this.$_mounted = true;
          }
          if (!this.popperInstance) {
            var popperOptions = _extends$1({}, this.popperOptions, { placement: this.placement });
            if (popperOptions.modifiers = _extends$1({}, popperOptions.modifiers, { arrow: { element: this.$refs.arrow } }), this.offset) {
              var offset2 = this.$_getOffset();
              popperOptions.modifiers.offset = { offset: offset2 };
            }
            this.boundariesElement && (popperOptions.modifiers.preventOverflow = { boundariesElement: this.boundariesElement }), this.popperInstance = new Popper(reference, popoverNode, popperOptions), requestAnimationFrame(function() {
              !_this3.$_isDisposed && _this3.popperInstance ? (_this3.popperInstance.scheduleUpdate(), requestAnimationFrame(function() {
                _this3.$_isDisposed ? _this3.dispose() : _this3.isOpen = true;
              })) : _this3.dispose();
            });
          }
          var openGroup = this.openGroup;
          if (openGroup) for (var popover = void 0, i2 = 0; i2 < openPopovers.length; i2++) popover = openPopovers[i2], popover.openGroup !== openGroup && (popover.hide(), popover.$emit("close-group"));
        ...
        if (this.isOpen) {
          ...
          -1 !== index && openPopovers.splice(index, 1), this.isOpen = false, this.popperInstance && this.popperInstance.disableEventListeners(), clearTimeout(this.$_disposeTimer);
          var disposeTime = directive.options.popover.disposeTimeout || directive.options.disposeTimeout;
          null !== disposeTime && (this.$_disposeTimer = setTimeout(function() {
            var popoverNode = _this4.$refs.popover;
            popoverNode && (popoverNode.parentNode && popoverNode.parentNode.removeChild(popoverNode), _this4.$_mounted = false);
          }, disposeTime)), this.$emit("apply-hide");
        }
      }, $_findContainer: function(container, reference) {
        return "string" == typeof container ? container = window.document.querySelector(container) : false === container && (container = reference.parentNode), container;
      }, $_getOffset: function() {
        var typeofOffset = _typeof(this.offset), offset2 = this.offset;
        return ("number" === typeofOffset || "string" === typeofOffset && -1 === offset2.indexOf(",")) && (offset2 = "0, " + offset2), offset2;
      }, $_addEventListeners: function() {
        var _this5 = this, reference = this.$refs.trigger, directEvents = [], oppositeEvents = [];
        ("string" == typeof this.trigger ? this.trigger.split(" ").filter(function(trigger) {
          ...
          var func = function(event2) {
            _this5.isOpen || (event2.usedByTooltip = true, !_this5.$_preventOpen && _this5.show({ event: event2 }));
          };
          _this5.$_events.push({ event, func }), reference.addEventListener(event, func);
        }), oppositeEvents.forEach(function(event) {
          var func = function(event2) {
            event2.usedByTooltip || _this5.hide({ event: event2 });
          };
          _this5.$_events.push({ event, func }), reference.addEventListener(event, func);
        });
      }, $_scheduleShow: function() {
        var skipDelay = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
        if (clearTimeout(this.$_scheduleTimer), skipDelay) this.$_show();
        else {
          var computedDelay = parseInt(this.delay && this.delay.show || this.delay || 0);
          this.$_scheduleTimer = setTimeout(this.$_show.bind(this), computedDelay);
        }
      }, $_scheduleHide: function() {
        var _this6 = this, event = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null, skipDelay = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
        if (clearTimeout(this.$_scheduleTimer), skipDelay) this.$_hide();
        else {
        ...
        var _this7 = this, reference = this.$refs.trigger, popoverNode = this.$refs.popover, relatedreference = event.relatedreference || event.toElement || event.relatedTarget, callback = function callback2(event2) {
          var relatedreference2 = event2.relatedreference || event2.toElement || event2.relatedTarget;
          popoverNode.removeEventListener(event.type, callback2), reference.contains(relatedreference2) || _this7.hide({ event: event2 });
        };
        return !!popoverNode.contains(relatedreference) && (popoverNode.addEventListener(event.type, callback), true);
      }, $_removeEventListeners: function() {
        var reference = this.$refs.trigger;
        this.$_events.forEach(function(_ref3) {
          var func = _ref3.func, event = _ref3.event;
        ...
        if (this.popperInstance) {
          ...
          this.dispose(), this.$_isDisposed = false, this.$_init(), isOpen && this.show({ skipDelay: true, force: true });
        }
      }, $_handleGlobalClose: function(event) {
        var _this8 = this, touch = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
        this.$_beingShowed || (this.hide({ event }), event.closePopover ? this.$emit("close-directive") : this.$emit("auto-hide"), touch && (this.$_preventOpen = true, setTimeout(function() {
          _this8.$_preventOpen = false;
        }, 300)));
      }, $_handleResize: function() {
        this.isOpen && this.popperInstance && (this.popperInstance.scheduleUpdate(), this.$emit("resize"));
      } } };
      "undefined" != typeof document && "undefined" != typeof window && (isIOS ? document.addEventListener("touchend", handleGlobalTouchend, !supportsPassive || { passive: true, capture: true }) : window.addEventListener("click", handleGlobalClick, true));
      var commonjsGlobal = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, lodash_merge = function(fn, module3) {
        ...
        function baseAssignValue(object, key, value) {
          "__proto__" == key && defineProperty2 ? defineProperty2(object, key, { configurable: true, enumerable: true, value, writable: true }) : object[key] = value;
        }
        ...
        function baseIsNative(value) {
          return !(!isObject(value) || isMasked(value)) && (isFunction2(value) ? reIsNative : reIsHostCtor).test(toSource(value));
        }
        ...
        function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
          ...
          if (isCommon) {
            ...
            newValue = srcValue, isArr || isBuff || isTyped ? isArray(objValue) ? newValue = objValue : isArrayLikeObject(objValue) ? newValue = copyArray(objValue) : isBuff ? (isCommon = false, newValue = cloneBuffer(srcValue, true)) : isTyped ? (isCommon = false, newValue = cloneTypedArray(srcValue, true)) : newValue = [] : isPlainObject(srcValue) || isArguments(srcValue) ? (newValue = objValue, isArguments(objValue) ? newValue = toPlainObject(objValue) : (!isObject(objValue) || srcIndex && isFunction2(objValue)) && (newValue = initCloneObject(srcValue))) : isCommon = false;
          }
        ...
        function isArrayLike(value) {
          return null != value && isLength(value.length) && !isFunction2(value);
        }
        ...
        }(), nativeObjectToString = objectProto.toString, objectCtorString = funcToString.call(Object), reIsNative = RegExp("^" + funcToString.call(hasOwnProperty).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Buffer = moduleExports ? root.Buffer : void 0, _Symbol = root.Symbol, Uint8Array = root.Uint8Array, allocUnsafe = Buffer ? Buffer.allocUnsafe : void 0, getPrototype = /* @__PURE__ */ function(func, transform) {
          return function(arg) {
            return func(transform(arg));
          };
        }(Object.getPrototypeOf, Object), objectCreate = Object.create, propertyIsEnumerable = objectProto.propertyIsEnumerable, splice = arrayProto.splice, symToStringTag = _Symbol ? _Symbol.toStringTag : void 0, defineProperty2 = function() {
          try {
            var func = getNative(Object, "defineProperty");
            return func({}, "", {}), func;
          } catch (e) {
          }
        }(), nativeIsBuffer = Buffer ? Buffer.isBuffer : void 0, nativeMax = Math.max, nativeNow = Date.now, Map = getNative(root, "Map"), nativeCreate = getNative(Object, "create"), baseCreate = /* @__PURE__ */ function() {
          function object() {
          }
        ...
        var baseFor = /* @__PURE__ */ function(fromRight) {
        ...
        }(baseSetToString), isArguments = baseIsArguments(/* @__PURE__ */ function() {
          return arguments;
        }()) ? baseIsArguments : function(value) {
          return isObjectLike(value) && hasOwnProperty.call(value, "callee") && !propertyIsEnumerable.call(value, "callee");
        }, isArray = Array.isArray, isBuffer = nativeIsBuffer || stubFalse, isTypedArray = nodeIsTypedArray ? /* @__PURE__ */ function(func) {
          return function(value) {
            return func(value);
          };
        }(nodeIsTypedArray) : baseIsTypedArray, merge = function(assigner) {
      ...
      }), VTooltip = directive, plugin = { install, get enabled() {
      ...
      var __WEBPACK_IMPORTED_MODULE_0_v_tooltip__ = __webpack_require__(4), __WEBPACK_IMPORTED_MODULE_1__Heatmap__ = __webpack_require__(2), __WEBPACK_IMPORTED_MODULE_2__consts_js__ = __webpack_require__(0);
      __WEBPACK_IMPORTED_MODULE_0_v_tooltip__.a.enabled = window.innerWidth > 768, __webpack_exports__.default = { directives: { tooltip: __WEBPACK_IMPORTED_MODULE_0_v_tooltip__.a }, props: { endDate: { required: true }, max: { type: Number }, rangeColor: { type: Array, default: function() {
        return __WEBPACK_IMPORTED_MODULE_2__consts_js__.a;
      } }, values: { required: true, type: Array }, locale: { type: Object }, tooltip: { type: Boolean, default: true }, tooltipUnit: { type: String, default: __WEBPACK_IMPORTED_MODULE_2__consts_js__.b }, vertical: { type: Boolean, default: false } }, data: function() {
        ...
        return { horizontal: this.LEFT_SECTION_WIDTH + this.SQUARE_SIZE * this.heatmap.weekCount + this.SQUARE_BORDER_SIZE, vertical: this.LEFT_SECTION_WIDTH + this.SQUARE_SIZE * __WEBPACK_IMPORTED_MODULE_2__consts_js__.c + this.RIGHT_SECTION_WIDTH };
      }, heigth: function() {
        return { horizontal: this.TOP_SECTION_HEIGTH + this.SQUARE_SIZE * __WEBPACK_IMPORTED_MODULE_2__consts_js__.c + this.SQUARE_BORDER_SIZE + this.BOTTOM_SECTION_HEIGTH, vertical: this.TOP_SECTION_HEIGTH + this.SQUARE_SIZE * this.heatmap.weekCount + this.SQUARE_BORDER_SIZE };
      }, viewbox: function() {
        return "0 0 " + this.width[this.position] + " " + this.heigth[this.position];
      }, daysLabelWrapperTransform: function() {
        return { horizontal: "translate(0, " + this.TOP_SECTION_HEIGTH + ")", vertical: "translate(" + this.LEFT_SECTION_WIDTH + ", 0)" };
      }, monthsLabelWrapperTransform: function() {
        return { horizontal: "translate(" + this.LEFT_SECTION_WIDTH + ", 0)", vertical: "translate(0, " + this.TOP_SECTION_HEIGTH + ")" };
      }, legendWrapperTransform: function() {
        return { horizontal: "translate(" + (this.width[this.position] - this.SQUARE_SIZE * this.rangeColor.length - 30) + ", " + (this.heigth[this.position] - this.BOTTOM_SECTION_HEIGTH) + ")", vertical: "translate(" + (this.LEFT_SECTION_WIDTH + this.SQUARE_SIZE * __WEBPACK_IMPORTED_MODULE_2__consts_js__.c) + ", " + this.TOP_SECTION_HEIGTH + ")" };
        ...
        return this.locale ? { months: this.locale.months || __WEBPACK_IMPORTED_MODULE_2__consts_js__.e.months, days: this.locale.days || __WEBPACK_IMPORTED_MODULE_2__consts_js__.e.days, on: this.locale.on || __WEBPACK_IMPORTED_MODULE_2__consts_js__.e.on, less: this.locale.less || __WEBPACK_IMPORTED_MODULE_2__consts_js__.e.less, more: this.locale.more || __WEBPACK_IMPORTED_MODULE_2__consts_js__.e.more } : __WEBPACK_IMPORTED_MODULE_2__consts_js__.e;
      } }, methods: { tooltipOptions: function(day) {
        return !!this.tooltip && { content: "<b>" + day.count + " " + this.tooltipUnit + "</b> " + this.lo.on + " " + this.lo.months[day.date.getMonth()] + " " + day.date.getDate() + ", " + day.date.getFullYear(), delay: { show: 150, hide: 50 } };
      ...
      module2.exports = { render: function() {
        var _vm = this, _h = _vm.$createElement, _c = _vm._self._c || _h;
        return _c("svg", { staticClass: "vch__wrapper", attrs: { viewBox: _vm.viewbox } }, [_c("g", { staticClass: "vch__months__labels__wrapper", attrs: { transform: _vm.monthsLabelWrapperTransform[_vm.position] } }, _vm._l(_vm.heatmap.firstFullWeekOfMonths, function(month, index) {
          return _c("text", { staticClass: "vch__month__label", attrs: { x: _vm.getMonthLabelPostion(month).x, y: _vm.getMonthLabelPostion(month).y } }, [_vm._v(_vm._s(_vm.lo.months[month.value]))]);
        })), _c("g", { staticClass: "vch__days__labels__wrapper", attrs: { transform: _vm.daysLabelWrapperTransform[_vm.position] } }, [_c("text", { staticClass: "vch__day__label", attrs: { x: _vm.vertical ? 1 * _vm.SQUARE_SIZE : 0, y: _vm.vertical ? _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE : 20 } }, [_vm._v(_vm._s(_vm.lo.days[1]))]), _c("text", { staticClass: "vch__day__label", attrs: { x: _vm.vertical ? 3 * _vm.SQUARE_SIZE : 0, y: _vm.vertical ? _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE : 44 } }, [_vm._v(_vm._s(_vm.lo.days[3]))]), _c("text", { staticClass: "vch__day__label", attrs: { x: _vm.vertical ? 5 * _vm.SQUARE_SIZE : 0, y: _vm.vertical ? _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE : 69 } }, [_vm._v(_vm._s(_vm.lo.days[5]))])]), _c("g", { staticClass: "vch__legend__wrapper", attrs: { transform: _vm.legendWrapperTransform[_vm.position] } }, [_c("text", { attrs: { x: _vm.vertical ? 1.25 * _vm.SQUARE_SIZE : -25, y: _vm.vertical ? 8 : _vm.SQUARE_SIZE + 1 } }, [_vm._v(_vm._s(_vm.lo.less))]), _vm._l(_vm.rangeColor, function(color, index) {
          return _c("rect", { key: index, style: { fill: color }, attrs: { width: _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE, height: _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE, x: _vm.vertical ? 1.75 * _vm.SQUARE_SIZE : _vm.SQUARE_SIZE * index, y: _vm.vertical ? _vm.SQUARE_SIZE * (index + 1) : 5 } });
        }), _c("text", { attrs: { x: _vm.vertical ? 1.25 * _vm.SQUARE_SIZE : _vm.SQUARE_SIZE * _vm.rangeColor.length + 1, y: _vm.vertical ? _vm.SQUARE_SIZE * (_vm.rangeColor.length + 2) - _vm.SQUARE_BORDER_SIZE : _vm.SQUARE_SIZE + 1 } }, [_vm._v(_vm._s(_vm.lo.more))])], 2), _c("g", { staticClass: "vch__year__wrapper", attrs: { transform: _vm.yearWrapperTransform } }, _vm._l(_vm.heatmap.calendar, function(week, weekIndex) {
          return _c("g", { key: weekIndex, staticClass: "vch__month__wrapper", attrs: { transform: _vm.getWeekPosition(weekIndex) } }, _vm._l(week, function(day, dayIndex) {
            return day.date < _vm.now ? _c("rect", { directives: [{ name: "tooltip", rawName: "v-tooltip", value: _vm.tooltipOptions(day), expression: "tooltipOptions(day)" }], key: dayIndex, staticClass: "vch__day__square", style: { fill: _vm.rangeColor[day.colorIndex] }, attrs: { transform: _vm.getDayPosition(dayIndex), width: _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE, height: _vm.SQUARE_SIZE - _vm.SQUARE_BORDER_SIZE }, on: { click: function($event) {
...
// node_modules/vue-calendar-heatmap/index.js
var vue_calendar_heatmap_exports = {};
__export(vue_calendar_heatmap_exports, {
  default: () => import_vue_calendar_heatmap2.default
});
var import_vue_calendar_heatmap2 = __toESM(require_vue_calendar_heatmap_common());
__reExport(vue_calendar_heatmap_exports, __toESM(require_vue_calendar_heatmap_common()));
import "C:/PROJETOS_PESSOAIS/FocusVue/node_modules/vue-calendar-heatmap/dist/vue-calendar-heatmap.css";
var export_default = import_vue_calendar_heatmap2.default;
export {
  export_default as default
};
//# sourceMappingURL=vue-calendar-heatmap.js.map
